...
## Subsequent authorized full supplied batch

The existing four-site FT recipe completed run `a1b8a0fab85241c2b8babd2f1062af23` at 01:43:41 UTC / 09:43:41 Taipei. VNC showed TESTPROGRAM_BOUND, recipe IDLE, 74 pass / 6 fail over 80 devices. Public backend retained 1,710 events, 476 predictions joined to 476 actuals, three incidents and three evidence records; supplied wafer 02 / lot B13456 final yield is 92.50%. An intermediate public snapshot contained 607 events and 172 predictions while the tester was executing, establishing incremental delivery before batch completion. No model change, VM reboot or Nexus restart was used.

Read-only public correlation identified the four missing pairs as stage 1, touchdown 3, device ordinals 9–12, sites 1–4. Stage 1 has 76 pairs; each other stage has 80. There are 119 distinct requests versus 120 expected. Source sequences 3–760 are continuous; sequence 91 starts touchdown 3, sequence 92 is already stage 2. This suggests omission before relay delivery but does not establish the exact source/native boundary. It resembles the older touchdown-9 gap and remains unresolved. No speculative retry or new test run was performed to hide this limit. [Machine-readable result](recovery_full_batch.json) preserves counts and scope.

Scope `80727b22581b44579471eebfb2ef4a5e` contains only startup tp_info, with no devices or predictions. The UI hides that startup scope and the two earlier recovery probes; backend audit records are preserved. Current Live picker retains this full run plus `04dcb07358ee4f3da41e5cbc12cb9850` and `3f46468325ac47de894e6a13d3c672e0`, all named Gemini run. Future runs remain discoverable. Only one supplied wafer was available for verified tester execution; the 25-wafer summary is historical replay.
