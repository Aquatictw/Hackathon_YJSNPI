...
export default function Home(){
 ...
 return <div className="shell"><header className="topbar"><a className="brand" href="/"><span className="brandmark"><Activity size={22}/></span> RTDI <span className="brandlight">Insight</span></a><div className="header-right"><span className="mode"><FlaskConical size={14}/> 本機原型</span><span className="team">G6</span></div></header>
