...
export default function ReplayPage(){
 ...
 {data&&total&&<><div className="replay-overview"><div className="stats" aria-label="Replay summary"><div><span>Dataset</span><strong>{data.wafers.length}<small>wafers</small></strong><p>{total.devices.toLocaleString()} completed devices</p></div><div><span>Recorded alerts</span><strong>{total.alerts}<small>records</small></strong><p>Across {total.alertedWafers} wafers</p></div><div><span>Source mode</span><strong>REPLAY</strong><p>Schema-validated historical summary</p></div><div><span>Tester receipt</span><strong>Not provided</strong><p>No receipt in this summary</p></div></div><div className="replay-wafer-slot"><WaferScene/></div></div>
 ...
 <footer><span><FlaskConical size={13}/> {source} · Refresh restores the bundled snapshot</span><a href="/workspace">Run workspace <ArrowUpRight size={13}/></a></footer></>}
 </main></div>;
}
