...
export default function ReplayPage(){
 ...
 const [detailOpen,setDetailOpen]=useState(true),[tab,setTab]=useState('analysis'),[copyPending,setCopyPending]=useState(false),[copyError,setCopyError]=useState('');
 ...
 function tileClick(id:string){if(id===waferId)setDetailOpen(open=>!open);else selectWafer(id);} function selectWafer(id:string){setDetailOpen(true);setWaferId(id);setAlertIndex(0);resetCopy();}
