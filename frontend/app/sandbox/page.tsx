...
function Trend({evidence:e}: {evidence:EvidenceRecord}){
 ...
 const colors=['#5673e8','#ac6b28','#a5588d','#24866b'];
 ...
 {[0,1,2,3].map(i=>{const v=min+(max-min)*i/3;return <g key={i}><path d={`M53 ${y(v)}H620`} stroke="#eef1f7"/><text x="40" y={y(v)+4} textAnchor="end">{valueLabel(v)}</text></g>})}
